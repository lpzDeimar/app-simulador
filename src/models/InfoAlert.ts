export enum Error {
  AGE = "Error debe ingresar una edad",
  DISEASE = "Error debe ingresar una cantidad de lesiones",
...
export enum Contact {
  ABOGADO = "Te recomendamos agendar una llamada con un Abogado experto de la firma",
}
